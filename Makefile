...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	git diff --exit-code config/crd config/rbac
...
build: generate fmt vet ## Build manager binary.
	CGO_ENABLED=0 go build -a -o bin/manager -ldflags "-X github.com/redhat-openshift-ecosystem/operator-certification-operator/version.commit=$(SHAVERSION) -X github.com/redhat-openshift-ecosystem/operator-certification-operator/version.version=$(VERSION)" cmd/main.go
